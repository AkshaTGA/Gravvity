...
export const setupScene = () => {
  ...
  renderer = new THREE.WebGLRenderer({ antialias: false, powerPreference: "high-performance" }); // create a WebGLRenderer and set its antialias property to true to enable antialiasing which smooths out the edges of what is rendered
  ...
  renderer.setPixelRatio(Math.min(window.devicePixelRatio, 1.5)); // Limit pixel ratio for smoother performance on high-DPI screens
  renderer.setClearColor(0x121212, 1); // set the background color of the renderer
