                      ...
                      >
                        <div className="flex items-start gap-4">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-2 items-center text-sm text-foreground/70 mb-2">
                              <span className="font-medium text-foreground">
                                {b.author}
                              </span>
                              <span>•</span>
                              <span>{b.rollNumber}</span>
                              {b.category && (
                                <>
                                  <span>•</span>
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noreferrer"
                              className="text-xs text-purple-300 underline break-all line-clamp-1 hover:text-purple-200"
                            >
                              {b.mediumUrl}
                            </a>
                          </div>
                        ...
                        <div className="flex gap-2 pt-2 border-t border-border">
                          ...
                          <button
                            ...
                            className="flex-1 px-4 py-2 rounded-lg bg-card border border-border hover:bg-card/80 text-red-400"
                          >
                            Reject
                          </button>
                        </div>
                        ...
                        >
                          ...
                          <div className="flex gap-2 pt-2 border-t border-border">
                            <button
                              ...
                              className="w-full px-4 py-2 rounded-lg bg-card border border-border hover:bg-card/80 text-red-400"
                            >
                              Remove
                            </button>
                          </div>
