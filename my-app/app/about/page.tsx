    ...
    <>
      ...
      <main className="min-h-screen bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          {/* Header */}
          <div className="mb-16 slide-in-up flex flex-col items-center text-center">
            <h1 className="text-5xl md:text-6xl font-bold gradient-text mb-4">About Gravity</h1>
            <p className="text-xl text-foreground/70 text-center">Building the future of technology together</p>
          </div>
