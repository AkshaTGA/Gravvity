        ...
        >
          <div className="space-y-5">
            ...
            <p className="text-white/60 text-base leading-relaxed">
              ...
              solutions. From AI to Web Development and emerging tech — bring your best ideas and build something
              that matters.
            </p>
            <p className="text-white/60 text-base leading-relaxed">
          ...
          <div className="space-y-4">
            {[
              ...
              { icon: Code2, title: 'Open Domains', desc: 'AI, Web, systems, and more — your choice' },
